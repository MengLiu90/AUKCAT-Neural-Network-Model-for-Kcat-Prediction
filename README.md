...
```python predict_kcat.py --ckpt ./Trained_models/Human-specialist_models/Substrate_model_for_human_kcat_prediction.pth --input your_data_path/your_data.csv --out pred_human_kcat_substrate_based.csv```
